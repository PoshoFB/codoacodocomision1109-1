...
public class AlumnosDAO {
    ...
    public List<Alumnos> listarAlumnos() {
        ...
        Como List es una interfaz, no podemos crear un objeto List directamente. 
        Sin embargo, podemos crear objetos de las clases que implementan la interfaz de la Lista: ArrayList, LinkedList, Vector y Stack.*/
    ...
    public Alumnos mostrarAlumno(int _id) {
        ...
        try {
            ps = conexion.prepareStatement("SELECT id, nombre, apellidos,"
    ...
    public boolean insertarAlumno(Alumnos alumno) {
        PreparedStatement ps;
        try {
            ps = conexion.prepareStatement("INSERT INTO participantes(nombre, apellidos,"
    ...
    public boolean actualizarAlumno(Alumnos alumno){
        PreparedStatement ps;
        try {
            ps = conexion.prepareStatement("UPDATE participantes SET nombres=?, "
